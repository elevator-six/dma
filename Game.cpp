...
uintptr_t GameDecrypts::decrypt_client_info()
{
        ...
        rbx = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0x138AB798);
        if(!rbx)
                return rbx;
        ...
        rcx ^= k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B20E3);             //xor rcx, [0x00000000081983B0]
...
uintptr_t GameDecrypts::decrypt_client_base()
{
        ...
        case 0:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081BABAC]
                rax = rdx;              //mov rax, rdx
        ...
        case 1:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081BA775]
        ...
        case 2:
        {
                ...
                rcx = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov rcx, [0x00000000081BA275]
        ...
        case 3:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B9ED9]
        ...
        case 4:
        {
                ...
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);               //mov r9, [0x00000000081B9890]
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = rotl64(rax, 0x10);               //rol rax, 0x10
                rax ^= r9;              //xor rax, r9
                rax = __bswap_64(rax);            //bswap rax
        ...
        case 5:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B93D9]
        ...
        case 6:
        {
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);               //mov r9, [0x00000000081B8F58]
                rdx -= r11;             //sub rdx, r11
                rax = rdx;              //mov rax, rdx
                rax >>= 0x12;           //shr rax, 0x12
                rdx ^= rax;             //xor rdx, rax
        ...
        case 7:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B89F4]
                rcx = r11;              //mov rcx, r11
        ...
        case 8:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B8551]
        ...
        case 9:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B8072]
                rax = rdx;              //mov rax, rdx
        ...
        case 10:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B7B9F]
        ...
        case 11:
        {
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);               //mov r9, [0x00000000081B764F]
                rax = rdx;              //mov rax, rdx
                rax >>= 0x12;           //shr rax, 0x12
                rdx ^= rax;             //xor rdx, rax
                rax = rdx;              //mov rax, rdx
        ...
        case 12:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B710E]
                rdx ^= r11;             //xor rdx, r11
        ...
        case 13:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B6D16]
        ...
        case 14:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);              //mov r10, [0x00000000081B6889]
        ...
        case 15:
        {
                ...
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2129);               //mov r9, [0x00000000081B6389]
                rax = rdx;              //mov rax, rdx
...
uintptr_t GameDecrypts::decrypt_bone_base()
{
        const uint64_t mb = GameGlobals::module_base;
        uint64_t rax = mb, rbx = mb, rcx = mb, rdx = mb, rdi = mb, rsi = mb, r8 = mb, r9 = mb, r10 = mb, r11 = mb, r12 = mb, r13 = mb, r14 = mb, r15 = mb;
        rax = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xE2737F8);
        if(!rax)
                return rax;
        ...
        case 0:
        {
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);               //mov r9, [0x0000000007F81643]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r9;              //xor rcx, r9
                rcx = ~rcx;             //not rcx
        ...
        case 1:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F811F4]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r10;             //xor rcx, r10
                rcx = ~rcx;             //not rcx
        ...
        case 2:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F80D85]
                rdx = r13;              //mov rdx, r13
                rdx = ~rdx;             //not rdx
        ...
        case 3:
        {
                ...
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);               //mov r9, [0x0000000007F8079F]
                rcx = r13;              //mov rcx, r13
                rcx = ~rcx;             //not rcx
                rcx ^= rbx;             //xor rcx, rbx
                rax += rcx;             //add rax, rcx
        ...
        case 4:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F80224]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r10;             //xor rcx, r10
                rcx = ~rcx;             //not rcx
        ...
        case 5:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7FDA4]
        ...
        case 6:
        {
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);               //mov r9, [0x0000000007F7F885]
        ...
        case 7:
        {
                r11 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r11, [0x0000000007F7F474]
        ...
        case 8:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7EE53]
        ...
        case 9:
        {
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7E9F7]
        ...
        case 10:
        {
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);               //mov r9, [0x0000000007F7E578]
        ...
        case 11:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7DFAC]
                rcx = rax;              //mov rcx, rax
                rcx >>= 0x1B;           //shr rcx, 0x1B
                rax ^= rcx;             //xor rax, rcx
                rcx = rax;              //mov rcx, rax
        ...
        case 12:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7D98E]
                rax += rbx;             //add rax, rbx
                rcx = rax;              //mov rcx, rax
                rcx >>= 0x10;           //shr rcx, 0x10
                rax ^= rcx;             //xor rax, rcx
        ...
        case 13:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7D4EB]
                rcx = rax;              //mov rcx, rax
        ...
        case 14:
        {
                ...
                r9 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);               //mov r9, [0x0000000007F7CF10]
                rcx = rbx;              //mov rcx, rbx
                rcx = ~rcx;             //not rcx
        ...
        case 15:
        {
                ...
                r10 = k_memory.ReadNb<uintptr_t>(GameGlobals::module_base + 0xA8B2221);              //mov r10, [0x0000000007F7C9DF]
                rdx = 0;                //and rdx, 0xFFFFFFFFC0000000
                rdx = rotl64(rdx, 0x10);               //rol rdx, 0x10
                rcx = rax;              //mov rcx, rax
                rdx ^= r10;             //xor rdx, r10
